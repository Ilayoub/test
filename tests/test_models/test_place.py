#!/usr/bin/python3
"""
Test contains the TestPlaceDocs classes
"""
...
class TestPlaceDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_place(self):
        """Tests if models/place.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_place(self):
        """Tests if tests/test_models/test_place.py conforms to PEP8"""
        pep8s = pep8.StyleGuide(quiet=True)
...
class TestPlace(unittest.TestCase):
    ...
    def test_max_guest_attr(self):
        """Tests Place has attr max_guest, and it's an int == 0"""
        place = Place()
