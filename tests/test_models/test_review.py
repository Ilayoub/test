#!/usr/bin/python3
"""
Test contains the TestReviewDocs classes
"""
...
class TestReviewDocs(unittest.TestCase):
    """Tests to check the documentation and style of ReviewClass"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_review(self):
        """Tests if models/review.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_review(self):
        """Tests if tests/test_models/test_review.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
