#!/usr/bin/python3
"""
Test contains the TestCityDocs classes
"""
...
class TestCityDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_test_city(self):
        """Tests if tests/test_models/test_city.py conforms to PEP8"""
        pep8s = pep8.StyleGuide(quiet=True)
...
class TestCity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Tests if City has attribute name, and it's an empty string"""
        city = City()
    ...
    def test_state_id_attr(self):
        """Tests if City has attribute state_id, and it's an empty string"""
        city = City()
