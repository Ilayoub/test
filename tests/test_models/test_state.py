#!/usr/bin/python3
"""
Test contains the TestStateDocs classes
"""
...
class TestStateDocs(unittest.TestCase):
    """Tests to check the documentation and style of StateClass"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_state(self):
        """Tests if models/state.py conforms to PEP8"""
    ...
    def test_pep8_conformance_test_state(self):
        """Tests if tests/test_models/test_state.py conforms to PEP8"""
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_state_module_docstring(self):
        """Tests for the state.py module docstring"""
